...
chassis_high = 85  # 底座高度mm 90-20=70
arm_long = 100  # 手臂长度
elbow_hand_long = 215  # 手爪到肘长
...
while (True):
    ...
    chassised_angle_goal = chassised_angle_goal +45
    qwer = (chassised_angle_goal-135)
    chassised_angle_goal = chassised_angle_goal- qwer/1.9
    print('底盘绝对角度是：')
    ...
    #qwert= arm_angle_goal-50
    #arm_angle_goal = (arm_angle_goal -qwert*2)/44*144
    #elbow_angle_goal = elbow_angle_goal +17
    print('底座目标角度:')
    ...
    #time.sleep(3000)
    servo.position(2, 121)
    time.sleep(1000)
    servo.position(3, 100)
    time.sleep(1000)
